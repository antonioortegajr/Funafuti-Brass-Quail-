...
<html lang="en">
	<head>
		<title>#idxdev</title>
		<link class="i1Vy9" href="" rel="icon" type="image/png">
	...
	<body>
		...
		<div id="title_bar">
			<div id="title"><img src="img/idxdevlogo.png" width="200px"></div>
      ...
      <div class="drop drop_help_window" data-bind="event: { mouseover: load_contributors }">
		...
		function go(){
		    ...
		    rewrite.innerHTML='<button onCLick="go()">Change dynamic content</button><br>new stuff';
		}
		</script>
		 <style>
		  input#default {
